...
def connect():
    config = {}
    yml_path = os.path.join(os.path.dirname(__file__), '/Users/kayahir/Desktop/SWEN732/SWEN732-team1/PCP/config/db.yml')
...
def exec_sql_file(path):
    full_path = os.path.join(os.path.dirname(__file__), f'/Users/kayahir/Desktop/SWEN732/SWEN732-team1/PCP/server/src/db/UserDetail.sql')
    conn = connect()
    cur = conn.cursor()
