...
def user_signup(**kwargs):
    ...
    user_exists_query = 'SELECT username FROM users WHERE username = %s;'
    ...
    query_insert = 'INSERT INTO users (firstname, lastname, username, hashed_password, email) VALUES (%s, %s, %s, %s, %s);'
